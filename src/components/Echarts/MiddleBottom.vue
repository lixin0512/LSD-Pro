...
const config = reactive({
  ...
  data: [
    ["1号空压机", "稳定", "0.131/0.1", "0.128/0.1"],
    ["2号空压机", "稳定", "0.138/0.1", "0.127/0.1"],
    ["3号空压机", "稳定", "0.131/0.1", "0.128/0.1"],
    ["1号制冷机", "轻微波动", "5.68/5.6", "5.65/5.6"],
    ["2号制冷机", "严重波动", "5.9/5.6", "5.9/5.6"],
    ["1号地源热泵", "稳定", "7.38/7.3", "7.33/7.3"],
    ["2号地源热泵", "稳定", "7.35/7.3", "7.31/7.3"],
  ],
